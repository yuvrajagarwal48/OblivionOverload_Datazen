...
<body>
    <div class="container">
        <header>
            <h1>💰 Financial System Simulation Report</h1>
        ...
        <div class="content">
            ...
            <h2>🏆 Systemic Importance (DebtRank)</h2>
            <table>
                <thead>
                    <tr>
                        <th>Rank</th>
...
"""
        ...
        for bank_id, outcome in sorted(
            ...
            status_emoji = "🟢" if outcome['final_status'] == "active" else \
                          "🟡" if outcome['final_status'] == "stressed" else "🔴"
