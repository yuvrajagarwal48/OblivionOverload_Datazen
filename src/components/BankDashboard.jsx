 ...
 * Shows:
 *   1. Own balance-sheet metrics
 *   2. Direct neighbors (names only, no detailed metrics)
 *   3. System-level aggregated metrics
 *   4. What-If Panel (transaction proposals)
 *   5. Transaction History (from Supabase)
 */
export default function BankDashboard() {
  ...
  // Find our bank node from the simulation state
  const myNode = useMemo(
    () => nodes.find((n) => String(n.id) === String(currentBankId)),
    [nodes, currentBankId]
  );
